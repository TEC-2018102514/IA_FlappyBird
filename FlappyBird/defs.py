...
BG_FILENAME = 'img\Skyline.png'


PIPE_FILENAME = 'img\Pipe.png'
PIPE_SPEED = 70/1000
PIPE_DONE = 1
PIPE_MOVING = 0
PIPE_UPPER = 1
...
# Add these constants
SURVIVAL_SCORE_RATE = 0.001  # Score rate for each frame survived without collision
PENALTY_FOR_COLLISION = 1   # Penalty for collision with a pipe
