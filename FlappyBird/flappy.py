...
BIRD_IMGS = [pygame.image.load('GameImages\Flappy Bird.png'),
             pygame.image.load('GameImages\Flappy Bird Wings Up.png'),
             pygame.image.load('GameImages\Flappy Bird Wings Down.png')]
BOTTOM_PIPE_IMG = pygame.image.load('GameImages\Super Mario pipe.png')
...
FLOOR_IMG = pygame.image.load('GameImages\Stone Floor.png')
BG_IMG = pygame.transform.scale(pygame.image.load('GameImages\City Skyline.png'), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
class Pipe:
    ...
    def random_height(self):
        ...
        self.bottom_pipe_topleft = self.top_pipe_height + self.VERTICAL_GAP #the topleft position of the bottom pipe should be the ran
